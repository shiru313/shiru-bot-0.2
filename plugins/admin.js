...
Asena.addCommand({pattern: 'ban ?(.*)', fromMe: false, onlyGroup: false, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
Asena.addCommand({pattern: 'promote ?(.*)', fromMe: false, onlyGroup: false, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asena.addCommand({pattern: 'demote ?(.*)', fromMe: false, onlyGroup: false, desc: Lang.DEMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
